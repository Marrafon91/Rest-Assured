...
public class OrderControllerRA {
    ...
    @Test
    public void findByIdShouldReturnOrderWhenIdExistsAndClientLoggedIn() {
        given()
                .header("Content-Type", "application/json ")
    ...
    @Test
    public void findByIdShouldReturnForbiddenWhenIdExistsAndClientLoggedInAndOrderDoesNotBelongUser() {
    ...
    @Test
    public void findByIdShouldReturnNotFoundWhenIdDoesNotExistsAndAdminLoggedIn() {
        given()
                .header("Content-Type", "application/json ")
                .header("Authorization", "Bearer " + adminToken)
                .accept(ContentType.JSON)
    ...
    @Test
    public void findByIdShouldReturnNotFoundWhenIdDoesNotExistsAndClientLoggedIn() {
        given()
                .header("Content-Type", "application/json ")
                .header("Authorization", "Bearer " + clientToken)
                .accept(ContentType.JSON)
