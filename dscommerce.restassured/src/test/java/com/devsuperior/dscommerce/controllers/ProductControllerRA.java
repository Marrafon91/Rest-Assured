...
public class ProductControllerRA {
    ...
    @Test
    public void findAllPagedShouldReturnProductWhenProductNameIsNotEmpty() {
    ...
    @Test
    public void findAllPagedShouldReturnProductByName() {
    ...
    @Test
    public void findAllPagedShouldReturnProductWithPriceEqualOrGreaterThan2000() {
    ...
    @Test
    public void insertProductShouldReturnUnprocessableEntityWhenAdminLoggedInAndInvalidName() {
    ...
    @Test
    public void insertProductShouldReturnUnprocessableEntityWhenAdminLoggedInAndInvalidDescription() {
    ...
    @Test
    public void insertProductShouldReturnUnprocessableEntityWhenAdminLoggedInAndPriceIsNegative() {
        postProductInstance.put("price", -50.0);
        JSONObject newProduct = new JSONObject(postProductInstance);
    ...
    @Test
    public void insertProductShouldReturnUnprocessableEntityWhenAdminLoggedInAndPriceIsZero() {
    ...
    @Test
    public void insertProductShouldReturnUnprocessableEntityWhenAdminLoggedInAndProductHasNoCategory() {
    ...
    @Test
    public void insertShouldReturnForbiddenWhenClientLoggedIn() {
        JSONObject newProduct = new JSONObject(postProductInstance);
    ...
    @Test
    public void deleteShouldReturnNoContentWhenIdExistsAdminLoggedInAndProductDeleted() {
        given()
                .header("Authorization", "Bearer " + adminToken)
                .accept(ContentType.JSON)
                .when()
    ...
    @Test
    public void deleteShouldReturnNotFoundWhenIdDoesNotExistsAndAdminLoggedIn() {
        given()
                .header("Authorization", "Bearer " + adminToken)
                .accept(ContentType.JSON)
                .when()
    ...
    @Test
    public void deleteShouldReturnBadRequestWhenDependentIdAndAdminLoggedIn() {
        given()
                .header("Authorization", "Bearer " + adminToken)
                .accept(ContentType.JSON)
                .when()
    ...
    @Test
    public void deleteShouldReturnForbiddenWhenClientLoggedIn() {
        given()
                .header("Authorization", "Bearer " + clientToken)
                .accept(ContentType.JSON)
                .when()
    ...
    @Test
    public void deleteShouldReturnUnauthorizedWhenNotLoggedInOrInvalidToken() {
        given()
                .header("Authorization", "Bearer " + invalidToken)
                .contentType(ContentType.JSON)
                .when()
